...
public class Money
{
   ...
   */
   ...
   /**
      Copy constructor
      @param The Money object to copy.
   */
   ...
   */
   ...
   /**
      The equals method
      @param amount The Money object to test for equality.
      @return true if the dollars and the cents of the
              calling object are the same as the dollars
